                ...
                <div className="headgradient">
                    <div className="headnav">
                        ...
                        <div className="logo-right">
                            ...
                            <button className="signin" onClick={onClickHandle}>
                                Sign in
                            </button>
                        </div>
                    </div>
                    <div className="contentContain">
                        <div className="header-content">
                            <div className='Unlimited'>Unlimited movies, TV shows and more.</div>
